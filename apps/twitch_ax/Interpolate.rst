                              ...
                              4 ; This file was generated Thu Nov 22 23:15:58 2012
                              5 ;--------------------------------------------------------
   ...
   F031                     571 	.ds 2
                    ...
                    0000    781 	C$Interpolate.c$16$0$0 ==.
                            782 ;	apps/wireless_serial_twitch/Interpolate.c:16: int16 interpolate(int16 value, int16 minVal, int16 maxVal, int16 minRtn, int16 maxRtn){
                            783 ;	-----------------------------------------
   ...
   0A18 AF 83               796 	mov	r7,dph
                    0004    797 	C$Interpolate.c$21$1$1 ==.
                            798 ;	apps/wireless_serial_twitch/Interpolate.c:21: lRtnRange = maxRtn - minRtn;
   ...
   0A39 F5 27               820 	mov	(_interpolate_lRtnRange_1_1 + 3),a
                    0025    821 	C$Interpolate.c$22$1$1 ==.
                            822 ;	apps/wireless_serial_twitch/Interpolate.c:22: lValRange = maxVal - minVal;
   ...
   0A5A F5 2B               844 	mov	(_interpolate_lValRange_1_1 + 3),a
                    0046    845 	C$Interpolate.c$23$1$1 ==.
                            846 ;	apps/wireless_serial_twitch/Interpolate.c:23: lRelVal = value - minVal;
   ...
   0A78 F2                  872 	movx	@r0,a
                    0063    873 	C$Interpolate.c$24$1$1 ==.
                            874 ;	apps/wireless_serial_twitch/Interpolate.c:24: lRtnRange =  minRtn + ( lRtnRange * lRelVal / lValRange );
   ...
   0AD3 F5 27               927 	mov	(_interpolate_lRtnRange_1_1 + 3),a
                    00BF    928 	C$Interpolate.c$25$1$1 ==.
                            929 ;	apps/wireless_serial_twitch/Interpolate.c:25: return (int16)lRtnRange;
   ...
   0ADB 22                  934 	ret
                    ...
                    00C6    943 	C$Interpolate.c$37$1$1 ==.
                            944 ;	apps/wireless_serial_twitch/Interpolate.c:37: uint16 interpolateU(int16 value, int16 minVal, int16 maxVal, uint16 minRtn, uint16 maxRtn){
                            945 ;	-----------------------------------------
   ...
   0ADE AF 83               950 	mov	r7,dph
                    00CA    951 	C$Interpolate.c$42$1$1 ==.
                            952 ;	apps/wireless_serial_twitch/Interpolate.c:42: lRtnRange = maxRtn - minRtn;
   ...
   0AFC 75 33 00            971 	mov	(_interpolateU_lRtnRange_1_1 + 3),#0x00
                    00E9    972 	C$Interpolate.c$43$1$1 ==.
                            973 ;	apps/wireless_serial_twitch/Interpolate.c:43: lValRange = maxVal - minVal;
   ...
   0B1C F5 37               993 	mov	(_interpolateU_lValRange_1_1 + 3),a
                    0108    994 	C$Interpolate.c$44$1$1 ==.
                            995 ;	apps/wireless_serial_twitch/Interpolate.c:44: lRelVal = value - minVal;
   ...
   0B34 F5 3B              1013 	mov	(_interpolateU_lRelVal_1_1 + 3),a
                    0120   1014 	C$Interpolate.c$47$1$1 ==.
                           1015 ;	apps/wireless_serial_twitch/Interpolate.c:47: lRelVal *= lRtnRange;
   ...
   0B66 8F 3B              1044 	mov	(_interpolateU_lRelVal_1_1 + 3),r7
                    0152   1045 	C$Interpolate.c$48$1$1 ==.
                           1046 ;	apps/wireless_serial_twitch/Interpolate.c:48: lRelVal /= lValRange;
   ...
   0B90 F5 3B              1067 	mov	(_interpolateU_lRelVal_1_1 + 3),a
                    017C   1068 	C$Interpolate.c$50$1$1 ==.
                           1069 ;	apps/wireless_serial_twitch/Interpolate.c:50: lRtnRange =  minRtn + lRelVal;
   ...
   0BB2 8F 33              1094 	mov	(_interpolateU_lRtnRange_1_1 + 3),r7
                    019E   1095 	C$Interpolate.c$52$1$1 ==.
                           1096 ;	apps/wireless_serial_twitch/Interpolate.c:52: return (uint16)lRtnRange;
